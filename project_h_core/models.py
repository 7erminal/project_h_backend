...
class Documents(models.Model):
	...
	customer = models.OneToOneField(Customers, on_delete=models.CASCADE, related_name='customer_documents')
	selfie = models.ImageField(upload_to='documents')
	id_type = models.ForeignKey(IDTypes, null=True, blank=True, on_delete=models.CASCADE, related_name='host_id_type')
...
class Services(models.Model):
	...
	service_category_name_ENGLISH = models.CharField(max_length=255, null=True, blank=True)
	service_category_name_FRENCH = models.CharField(max_length=255, null=True, blank=True)
	service_category_name_SPANISH = models.CharField(max_length=255, null=True, blank=True)
	service_category_name_PORTUGAL = models.CharField(max_length=255, null=True, blank=True)
	description = models.TextField(null=True, blank=True)
	service_category_description_ENGLISH = models.CharField(max_length=255, null=True, blank=True)
	service_category_description_FRENCH = models.CharField(max_length=255, null=True, blank=True)
...
class HostDetails(models.Model):
	...
	service = models.ForeignKey(Services, null=True, blank=True, on_delete=models.CASCADE, related_name='host_details_service')
...
class ProfileMenu(models.Model):
	profile_menu_id = models.AutoField(primary_key=True)
	menu_number = models.IntegerField()
	menu_name_ENGLISH = models.CharField(max_length=255)
	menu_name_FRENCH = models.CharField(max_length=255, null=True, blank=True)
	menu_name_SPANISH = models.CharField(max_length=255, null=True, blank=True)
	menu_name_PORTUGAL = models.CharField(max_length=255, null=True, blank=True)
	menu_description_ENGLISH = models.CharField(max_length=255, null=True, blank=True)
	menu_description_FRENCH = models.CharField(max_length=255, null=True, blank=True)
	menu_description_SPANISH = models.CharField(max_length=255, null=True, blank=True)
	menu_description_PORTUGAL = models.CharField(max_length=255, null=True, blank=True)
	menu_icon = models.CharField(max_length=20)
	to_path = models.CharField(max_length=255, null=True, blank=True)
...
class ApplicationProperties(models.Model):
	application_property_id = models.AutoField(primary_key=True)
	application_property_name = models.CharField(max_length=150)
	application_property_name_ENGLISH = models.CharField(max_length=150, null=True, blank=True)
	application_property_name_FRENCH = models.CharField(max_length=150, null=True, blank=True)
	application_property_name_SPANISH = models.CharField(max_length=150, null=True, blank=True)
	application_property_name_PORTUGUESE = models.CharField(max_length=150, null=True, blank=True)
